...
func main() {
	sm := objects.InitBundle()

	// Create a campaign
	c := objects.InitCampaign("2.0")
	...
	infra := objects.InitInfrastructure("2.0")
	...
	od1 := objects.InitObservedData("2.0")
	...
	od2 := objects.InitObservedData("2.0")
	...
	od3 := objects.InitObservedData("2.0")
	...
	r1 := objects.InitRelationship("2.0")
