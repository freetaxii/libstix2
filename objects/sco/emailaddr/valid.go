...
TODO: Implement full validation per STIX 2.1 specification section 6.4
*/
func (o *EmailAddress) Valid(debug bool) (bool, int, []string) {
problemsFound := 0
...
// TODO: Add specific validation rules for EmailAddress
