...
*/
func Decode(data []byte) (*EmailAddr, error) {
	var o EmailAddr
...
*/
func (o *EmailAddr) UnmarshalJSON(b []byte) error {

	type alias EmailAddr
	temp := &struct {
		*alias
	}{
		alias: (*alias)(o),
...
*/
func (o *EmailAddr) Encode() ([]byte, error) {
...
JSON
*/
func (o *EmailAddr) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
