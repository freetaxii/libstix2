...
*/
func Decode(data []byte) (*NetworkTraffic, error) {
	var o NetworkTraffic
...
*/
func (o *NetworkTraffic) UnmarshalJSON(b []byte) error {

	type alias NetworkTraffic
	temp := &struct {
		*alias
	}{
		alias: (*alias)(o),
...
*/
func (o *NetworkTraffic) Encode() ([]byte, error) {
...
JSON
*/
func (o *NetworkTraffic) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
