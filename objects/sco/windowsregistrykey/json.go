...
*/
func Decode(data []byte) (*WindowsRegistryKey, error) {
	var o WindowsRegistryKey
...
*/
func (o *WindowsRegistryKey) UnmarshalJSON(b []byte) error {
	type alias WindowsRegistryKey
	temp := &struct {
		*alias
	}{
		alias: (*alias)(o),
