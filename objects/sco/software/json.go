...
*/
func Decode(data []byte) (*Software, error) {
	var o Software
...
*/
func (o *Software) UnmarshalJSON(b []byte) error {
...
*/
func (o *Software) Encode() ([]byte, error) {
...
JSON
*/
func (o *Software) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
