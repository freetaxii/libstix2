...
/*
Artifact - This type implements the STIX 2.1 Artifact SCO and defines all of the
...
Reference: STIX 2.1 specification section 6.1
*/
...
func (o *Artifact) GetPropertyList() []string {
	return []string{"mime_type", "payload_bin", "url", "hashes", "encryption_algorithm", "decryption_key"}
}
...
/*
New - This function will create a new STIX Artifact SCO and return it as a
