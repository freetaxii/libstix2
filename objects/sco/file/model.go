...
/*
File - This type implements the STIX 2.1 File SCO and defines all of the
...
Reference: STIX 2.1 specification section 6.6
*/
type File struct {
...
func (o *File) GetPropertyList() []string {
	return []string{"name", "hashes", "size", "name_enc", "magic_number_hex", "mime_type",
		"ctime", "mtime", "atime", "parent_directory_ref", "contains_refs", "content_ref"}
}
