...
*/
func Decode(data []byte) (*AutonomousSystem, error) {
...
*/
func (o *AutonomousSystem) UnmarshalJSON(b []byte) error {

	type alias AutonomousSystem
	temp := &struct {
		*alias
	}{
		alias: (*alias)(o),
...
*/
func (o *AutonomousSystem) Encode() ([]byte, error) {
...
JSON
*/
func (o *AutonomousSystem) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
