...
func (ezt *ExternalReferencesPropertyType) NewExternalReference() *ExternalReferenceType {
	e := ezt.newExternalRefernce()
	return e
}
...
func (ezt *ExternalReferencesPropertyType) newExternalRefernce() *ExternalReferenceType {
	...
	return &ezt.ExternalReferences[positionThatAppendWillUse]
}
