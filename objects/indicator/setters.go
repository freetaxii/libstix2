...
/*
AddType - This method takes in a string representing a categorization for this
indicator. The values SHOULD come from the indicator-type-ov open vocabulary.
*/
...
/*
SetPatternType - This method takes in a string representing the type of pattern
used in this indicator and will set the pattern_type property to that value. The
value should be one of "stix", "snort", or "yara".
*/
